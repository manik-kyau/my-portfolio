...
const Banner = () => {
    return (
        <div className='bg-[#2C3E50] flex h-full p-5 md:p-[80px]'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-8'>
                <div className='flex flex-col md:w-1/2'>
                    ...
                    <p className=" text-lg font-bold mt-3 mb-7 text-white"> Frontend Developer with a focus on React, creating user-friendly web interfaces. Passionate about Web Development, Software Engineering and interactive experiences. I have a graduate degree in Computer Science & Engineering (CSE), bringing fresh ideas and a strong drive for innovation.Let's connect and explore new opportunities!</p>
                    <a 
                    href="/public/Untitled document.pdf" 
                    download={`Untitled document.pdf`}
                    className='text-xl font-semibold text-white border-2 border-[#9af10f] px-3 py-2 my rounded-md w-[200px]'
                    >Download Resume</a>
                </div>
                <div className=''>
                    <img className='h-[400px] w-full md:w-[350px]' src={banner} alt="" />
                </div>
            </div>
        </div>
    );
