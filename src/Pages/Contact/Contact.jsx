                    ...
                    <div className="py-6 md:py-0">
                        ...
                        <div className="space-y-4 text-white">
                            ...
                            <p className="flex items-center">
                                ...
                                <a href="https://www.facebook.com/profile.php?id=100009168905374" className="ml-3 text-base md:text-lg font-normal" target="_blank">https://www.facebook.com/profile.php</a>
                            </p>
                            <p className="flex items-center">
                                <span className="text-base md:text-lg font-bold text-[#09caba]">LinkedIn :</span>
                                <a href="https://www.linkedin.com/in/md-manik-sarkar/" className="ml-3 text-base md:text-lg font-normal" target="_blank">www.linkedin.com/in/md-manik-sarkar</a>
                            </p>
                            <p className="flex items-center">
                                <span className="text-base md:text-lg font-bold text-[#09caba]">GitHub :</span>
                                <a href="https://github.com/manik-kyau" className="ml-3 text-base md:text-lg font-normal" target="_blank">https://github.com/manik-kyau</a>
                            </p>
                        </div>
                    </div>
